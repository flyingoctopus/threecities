...
void setup() {
  ...
  cp5.addToggle("CAM",   400, FirstScreenHeight + 25, menuHeight/2, menuHeight/2);
  cp5.addToggle("BLB", 500, FirstScreenHeight + 25, menuHeight/2, menuHeight/2);
  cp5.addNumberbox("Blob Min")
      .setPosition(600, FirstScreenHeight + 25)
     .setSize(50,20)
     .setRange(0,1)
     .setMultiplier(0.02) // set the sensitifity of the numberbox
     .setDirection(Controller.HORIZONTAL) // change the control direction to left/right
     .setValue(0.05)
     ;
  cp5.addNumberbox("Blob Max")
      .setPosition(700, FirstScreenHeight + 25)
     .setSize(50,20)
     .setRange(0,1)
     .setMultiplier(0.02) // set the sensitifity of the numberbox
     .setDirection(Controller.HORIZONTAL) // change the control direction to left/right
  ...
  rb = cp5.addRadioButton("CropBox")
     .setPosition(50, FirstScreenHeight + 25)
     .setSize(50, 50)
