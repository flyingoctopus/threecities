...
PImage logo, license;
PImage circle, fatcap, pencil, marker, chisel, spray, drip, eraser, clear;
int pickedX = 12; // colour brush
int mark; // colour drips
...
//      mc2.start();
    ...
    clear = loadImage("icons/clear.jpg");
